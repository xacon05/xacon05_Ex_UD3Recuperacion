...
/**
 * This class represents the main window for the Quiniela application.
 * It allows users to add, remove, and generate results for football matches.
 */
public class Apuesta extends javax.swing.JFrame {
    ...
    */
    ...
    /**
     * Handles the action when the "Nuevo" button is clicked.
     * Opens a dialog to create a new match.
    ...
    /**
     * Handles the action when the "Eliminar" button is clicked.
     * Removes the selected match from the lists.
     * @param evt The action event.
     */
    ...
    /**
     * Handles the action when the "Resetear" button is clicked.
     * Clears both the match list and the results list.
     * @param evt The action event.
     */
    ...
    * @param n2 The upper bound.
    * @return A random integer between n1 and n2.
    */
    ...
    /**
     * Handles the action when the "Realizar quiniela" button is clicked.
     * Generates random results (1, X, or 2) for each match in the list
     * and displays them in the results list.
     * @param evt The action event.
     */
     ...
     * @param partido The string representation of the match to add.
     */
    ...
    /**
     * Removes a match and its corresponding result from the lists based on the index.
     * @param indice The index of the match to remove.
     */
